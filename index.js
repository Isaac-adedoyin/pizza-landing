...
const CONFIG = {
  ...
  // Restaurant WhatsApp Phone Number for receiving orders (Primary)
  whatsappNumber: "36707443534",
...
function initApp() {
  ...
  const prizes = [
    ...
    { text: '25% Off 2nd Pizza', color: '#3498DB', textCol: '#ffffff', code: 'COLOMBIA-25', desc: 'Take a screenshot of this win now! Post it on your stories, tag @pizzacolombiaujpest on Facebook/Instagram/TikTok to receive your bonus gift! 🍕' }
  ];
  ...
  function showPrizeResult(prize, alreadySpun) {
    ...
    if (prize.code) {
      ...
      const winTitle = currentLang === 'hu'
        ? (wheelTranslations.hu[prize.text]?.winTitle || `VÁSÁROLJ EGY PIZZÁT és kapj: ${prize.text}!`)
        : (wheelTranslations.en[prize.text]?.winTitle || `BUY A PIZZA and Get ${prize.text}!`);
      prizeTitle.innerText = winTitle;
  ...
  const uiTranslations = {
    en: {
      ...
      whats_new_spin_text: 'Daily chance to win free pizzas, drinks, and desserts.',
      whats_new_spin_cta: 'Read More →',
      whats_new_takeaway_badge: 'Takeaway',
      whats_new_takeaway_title: 'Order and pay online',
      whats_new_takeaway_text: 'Order from our digital menu, pay with SumUp, and confirm via WhatsApp.',
      ...
      home_offers_text: 'Special promotions and discounts appear here when available.',
      home_offers_cta: 'View Offers →',
      whats_new_social_title: 'Latest Updates',
      whats_new_social_text: 'Follow us on Instagram for daily specials and updates.',
      whats_new_social_cta: 'Follow on Instagram →',
      showcase1_title: 'Authentic Pizza & Live Event Catering',
      showcase1_subtitle: 'Baked fresh in our pizzeria or live at your venue.',
      card1_title: '🔥 Mobile Gas Ovens for Off-Site Catering',
      card1_text: 'For corporate events, private functions, birthdays, weddings, and festivals, we bring our professional mobile gas-fired pizza ovens directly to your venue and bake authentic Neapolitan pizzas fresh on-site creating an unforgettable live food experience for your guests',
      ...
      card2_text: 'At Pizza Colombia, our electric deck oven forms the heart of our kitchen. It delivers consistent heat across the stone deck, producing our signature crust, airy cornicione, and perfectly baked NY style pizzas every time.',
      ...
      catering_outro: 'From private parties to large festivals, we bring authentic Italian pizza live to your venue.',
      tagline: 'Fresh. Authentic. Fired with Passion.',
      showcase2_title: 'Fresh & Premium Ingredients',
      showcase2_subheading: 'Exceptional pizza - We aim to please !',
      showcase2_text1: 'We use high-quality ingredients, starting with San Marzano tomatoes creating a naturally sweet and balanced sauce.',
      showcase2_text2: 'Each pizza is topped with premium ingredients complemented by locally sourced produce and quality imported Italian ingredients wherever possible.',
      showcase2_text3: 'The result is simple, honest food that celebrates the authentic flavours of Italy — simple, fresh, vibrant, and crafted with care in every bit',
      showcase3_title: 'Neapolitan Meets New York',
      showcase3_subheading: 'Two iconic styles, one kitchen.',
      showcase3_text1: 'The best of two classic pizza traditions.',
      comparison_neapolitan_title: '🍕 Neapolitan Style',
      comparison_neapolitan_desc: 'Light, airy sourdough crust with blistered cornicione, baked at high heat for authentic Italian flavor.',
      comparison_newyork_title: '🗽 New York Style',
      comparison_newyork_desc: 'Thin, crispy & foldable crust loaded with premium toppings and baked to golden perfection.',
      showcase3_text2: 'Artisanal Italian elegance or bold New York crunch — perfect for dine-in, takeaway, and live catering. 🍕',
      stat1_kicker: 'Dual Style',
      stat1_label: 'Neapolitan & New York',
      stat1_desc: 'High-heat baking for signature leopard crust & crispy slices.',
      stat2_kicker: 'Late Hours',
      stat2_label: 'Continuous Service',
      stat2_desc: 'Open daily for lunch, cozy dinners, and late-night cravings.',
      ...
      prize_25_second: '🍕 25% Off 2nd Pizza',
      prize_drink_500: '🥤 Free 500ml Drink',
      prize_drink_1000: '🥤 Free 1000ml Drink',
      prize_drink_upgrade: '🥤 Free Drink Upgrade',
      prize_dessert: '🍰 Free Dessert',
      tag_rare: 'Rare',
      tag_common: 'Common',
      tag_lucky: 'Lucky',
      wheel_hint: 'Click SPIN to test your luck!',
      wheel_spin_btn: 'SPIN',
      result_celebration_win: '🎉 WINNER! 🎉',
      wheel_terms: 'Valid for dine-in or pickup. Limit 1 spin and 1 voucher redemption per person per day.',
      order_mychef: 'Order Online',
      ...
      review2_text: '"Amazing pizza variety and top-tier quality! Very friendly owner and staff, highly recommend visiting or ordering."',
      review3_title: 'Google Review • 5 Stars',
      review3_text: '"Five stars for food, service, and atmosphere. Truly authentic taste, great dough, and fast friendly service!"',
      ...
      catering_subtitle: 'Batch orders and custom packages delivered fresh to your office or venue.',
      ...
      careers_subtitle: 'Join our kitchen and delivery team in Újpest. Select a role to apply.',
      ...
      privacy_summary: 'Pizza Colombia Újpest collects only the personal information needed to process orders, enquiries, applications, feedback and prize claims. Information may be securely stored in a restricted Google Sheet, and order details may be sent through WhatsApp. We retain data only as long as required for its purpose or by law. To access, correct or delete your data, or withdraw consent, contact pizzacolombiaujpest@gmail.com or +36 70 744 3534. Withdrawing consent does not affect processing previously carried out lawfully.',
    ...
    hu: {
      ...
      whats_new_spin_text: 'Napi pörgetés ingyen pizzáért, italért és desszertért.',
      whats_new_spin_cta: 'További részletek →',
      whats_new_takeaway_badge: 'Elvitel',
      whats_new_takeaway_title: 'Online rendelés és fizetés',
      whats_new_takeaway_text: 'Rendeljen a digitális étlapról, fizessen SumUppal és küldje el WhatsAppon.',
      ...
      home_offers_text: 'Különleges ajánlataink és akcióink itt jelennek meg.',
      home_offers_cta: 'Ajánlatok megtekintése →',
      whats_new_social_title: 'Legfrissebb hírek',
      whats_new_social_text: 'Kövessen minket Instagramon a napi ajánlatokért és hírekért.',
      whats_new_social_cta: 'Követés Instagramon →',
      showcase1_title: 'Autentikus pizza és élő rendezvény catering',
      showcase1_subtitle: 'Frissen sütve pizzériánkban vagy rendezvényén.',
      card1_title: '🔥 Mobil gázkemencék külső cateringhez',
      card1_text: 'Céges rendezvényekre, privát összejövetelekre, születésnapokra, esküvőkre és fesztiválokra professzionális, mobil gázüzemű kemencéinket közvetlenül a helyszínre szállítjuk, és a helyszínen frissen sütjük az autentikus nápolyi pizzákat, felejthetetlen élményt nyújtva a vendégeknek.',
      ...
      card2_text: 'A Pizza Colombiában az elektromos kemence jelenti a konyhánk szívét. Egyenletes hőt biztosít a samott lapon, így minden alkalommal garantálja a jellegzetes tésztánkat, a levegős peremet és a tökéletesen átsült New York-i stílusú pizzát.',
      ...
      catering_outro: 'Kisebb összejövetelektől a nagy rendezvényekig, elhozzuk az igazi olasz pizzaélményt.',
      tagline: 'Friss. Eredeti. Szenvedéllyel sütve.',
      showcase2_title: 'Friss és prémium alapanyagok',
      showcase2_subheading: 'Kivételes pizza – Célunk az Ön elégedettsége!',
      showcase2_text1: 'Kiváló minőségű alapanyagokat használunk, kezdve a San Marzano paradicsommal, amely természetesen édes és kiegyensúlyozott szószt eredményez.',
      showcase2_text2: 'Minden pizzát prémium alapanyagokkal koronázunk meg, amit lehetőség szerint helyi termelők árui és minőségi import olasz összetevők egészítenek ki.',
      showcase2_text3: 'Az eredmény egyszerű, őszinte étel, amely Olaszország autentikus ízeit ünnepli – egyszerű, friss, életteli és minden falatban odaadással elkészített.',
      showcase3_title: 'Nápoly találkozása New York-kal',
      showcase3_subheading: 'Két ikonikus stílus, egy konyha.',
      showcase3_text1: 'A két legnépszerűbb pizzahagyomány legjava.',
      comparison_neapolitan_title: '🍕 Nápolyi Stílus',
      comparison_neapolitan_desc: 'Könnyű, levegős kovászos tészta pirult peremmel, magas hőmérsékleten sütve az autentikus ízért.',
      comparison_newyork_title: '🗽 New York Stílus',
      comparison_newyork_desc: 'Vékony, ropogós és hajtogatható tészta bőséges feltéttel, aranybarnára sütve.',
      showcase3_text2: 'Kézműves olasz elegancia vagy ropogós New York-i szelet — ideális helyben, elvitelre és cateringre. 🍕',
      stat1_kicker: 'Két stílus',
      stat1_label: 'Nápolyi és New York',
      stat1_desc: 'Extrém magas hőmérséklet a tökéletes peremért és ropogós szeletekért.',
      stat2_kicker: 'Késői nyitvatartás',
      stat2_label: 'Folyamatos kiszolgálás',
      stat2_desc: 'Nyitva minden nap ebédre, vacsorára és késő esti pizzázáshoz.',
      ...
      prize_50_second: '🍕 50% kedvezmény a 2. pizzára',
      prize_25_second: '🍕 25% kedvezmény a 2. pizzára',
      prize_drink_500: '🥤 Ingyen 500ml ital',
      prize_drink_1000: '🥤 Ingyen 1L ital',
      prize_drink_upgrade: '🥤 Ingyen ital upgrade',
      prize_dessert: '🍰 Ingyen desszert',
      tag_rare: 'Ritka',
      tag_common: 'Gyakori',
      tag_lucky: 'Szerencsés',
      wheel_hint: 'Kattints a PÖRGETÉS gombra!',
      wheel_spin_btn: 'PÖRGETÉS',
      result_celebration_win: '🎉 NYERTES! 🎉',
      wheel_terms: 'Helyben fogyasztásra vagy elvitelre érvényes. Személyenként napi 1 pörgetés és 1 beváltás.',
      order_mychef: 'Rendelés Online',
      ...
      review2_text: '"Csodálatos pizzaválaszték és csúcsminőség! Nagyon barátságos tulajdonos és személyzet, erősen ajánlom a látogatást vagy a rendelést."',
      review3_title: 'Google Vélemény • 5 Csillag',
      review3_text: '"Öt csillag az ételekre, a kiszolgálásra és a hangulatra. Igazán autentikus ízvilág, nagyszerű tészta és gyors, barátságos kiszolgálás!"',
      ...
      catering_subtitle: 'Csoportos rendelések és egyedi menük irodákba és rendezvényekre.',
      ...
      careers_subtitle: 'Csatlakozz csapatunkhoz Újpesten. Válassz pozíciót a jelentkezéshez.',
      ...
      privacy_summary: 'A Pizza Colombia Újpest kizárólag a rendelésekhez, ajánlatkérésekhez, jelentkezésekhez, visszajelzésekhez és nyereményigénylésekhez szükséges személyes adatokat gyűjti. Az adatok biztonságosan tárolhatók korlátozott hozzáférésű Google-táblázatban, és a rendelési adatok WhatsAppon kerülhetnek továbbításra. Az adatokat csak a céljukhoz vagy a jogszabályok által előírt ideig őrizzük meg. Az adatokhoz való hozzáféréshez, azok helyesbítéséhez, törléséhez vagy a hozzájárulás visszavonásához vegye fel a kapcsolatot a pizzacolombiaujpest@gmail.com címen vagy a +36 70 744 3534 számon. A hozzájárulás visszavonása nem érinti a korábban jogszerűen végzett adatkezelést.',
      option_method_whatsapp: 'WhatsApp',
  ...
  const wheelTranslations = {
    en: {
      ...
      '50% Off 2nd Pizza': { text: '50% Off 2nd', winTitle: 'BUY A PIZZA and Get 50% Off 2nd Pizza!', desc: 'Take a screenshot of this win now! Post it on your stories, tag @pizzacolombiaujpest on Facebook/Instagram/TikTok to receive your bonus gift! 🍕' },
      '25% Off 2nd Pizza': { text: '25% Off 2nd', winTitle: 'BUY A PIZZA and Get 25% Off 2nd Pizza!', desc: 'Take a screenshot of this win now! Post it on your stories, tag @pizzacolombiaujpest on Facebook/Instagram/TikTok to receive your bonus gift! 🍕' },
      ...
      'Free Drink Upgrade': { text: 'Free Upgrade', winTitle: 'BUY A PIZZA and Get a Free Drink Upgrade!', desc: 'Take a screenshot of this win now! Post it on your stories, tag @pizzacolombiaujpest on Facebook/Instagram/TikTok to receive your bonus gift! 🥤' },
      'Free Dessert': { text: 'Free Dessert', winTitle: 'BUY A PIZZA and Get a Free Dessert!', desc: 'Take a screenshot of this win now! Post it on your stories, tag @pizzacolombiaujpest on Facebook/Instagram/TikTok to receive your bonus gift! 🍰' }
    },
    hu: {
      ...
      '50% Off 2nd Pizza': { text: '-50% a 2. pizzára', winTitle: 'VÁSÁROLJ EGY PIZZÁT és kapj 50% kedvezményt a 2.-ra!', desc: 'Készíts képernyőképet a nyereményről! Oszd meg történetedben, jelöld meg a @pizzacolombiaujpest fiókot Facebookon, Instagramon vagy TikTokon az ajándékodért! 🍕' },
      '25% Off 2nd Pizza': { text: '-25% a 2. pizzára', winTitle: 'VÁSÁROLJ EGY PIZZÁT és kapj 25% kedvezményt a 2.-ra!', desc: 'Készíts képernyőképet a nyereményről! Oszd meg történetedben, jelöld meg a @pizzacolombiaujpest fiókot Facebookon, Instagramon vagy TikTokon az ajándékodért! 🍕' },
      ...
      'Free Drink Upgrade': { text: 'Ingyen upgrade', winTitle: 'VÁSÁROLJ EGY PIZZÁT és kapj egy ingyen méretnövelést!', desc: 'Készíts képernyőképet a nyereményről! Oszd meg történetedben, jelöld meg a @pizzacolombiaujpest fiókot Facebookon, Instagramon vagy TikTokon az ajándékodért! 🥤' },
      'Free Dessert': { text: 'Ingyen desszert', winTitle: 'VÁSÁROLJ EGY PIZZÁT és kapj egy ingyen desszertet!', desc: 'Készíts képernyőképet a nyereményről! Oszd meg történetedben, jelöld meg a @pizzacolombiaujpest fiókot Facebookon, Instagramon vagy TikTokon az ajándékodért! 🍰' }
    }
  };
  ...
  const updateLanguageUI = () => {
    ...
    // Refresh prize result title if wheel was already spun
    const savedPrizeIndex = safeGetItem('pizza_wheel_prize');
    if (savedPrizeIndex !== null && typeof showPrizeResult === 'function') {
      const idx = parseInt(savedPrizeIndex, 10);
      if (prizes[idx]) {
        showPrizeResult(prizes[idx], true);
      }
    }
